    ...
    <div>
      <nav className="fixed w-full">
        ...
        <div className="flex flex-row w-full bg-black justify-between items-start py-4 px-2 text-white font-oxygen">
          {/* Row 1*/}
          <div
            className={`flex ${toggler ? "flex-col" : "flex-row"} justify-start gap-5`}
          >
            {/* Col 1 */}
            ...
            {/* Col 2 */}
            <div
              className={`list-none ${toggler ? "flex" : "hidden"} md:flex md:flex-row flex-col gap-4 justify-center items-center`}
            >
